...
RegisterCommand('ianotify', function(source, args, rawCommand)
    exports.pNotify:SendNotification({text = "Compra en IA Shop. YA! https://discord.gg/iashop", type = "info", timeout = (2500)})
end, false)